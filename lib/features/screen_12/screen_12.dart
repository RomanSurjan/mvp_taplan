                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: getHeight(context, 62),),
                          buttonGreen(
                            context,
                            height: 48,
                            width: 343,
                            ...
                            onTap: isActiveReg
                                      ...
                                      () {
                                        ...
                                        if (context.read<AuthorizationBloc>().state.id != null) {
                                          ...
                                          if (context.read<AuthorizationBloc>().state.phone != phone.text  && context.read<AuthorizationBloc>().state.phone != null) {
                                            textFieldColor[0] = Colors.red;
                                            textError = 'Номер телефона есть в базе данных сервиса';
                                          }
                                          ...
                                          if (context.read<AuthorizationBloc>().state.telegram != telegram.text  && context.read<AuthorizationBloc>().state.telegram != null) {
                                            ...
                                            isPressed = true;
                                            textError = 'Телеграм уже есть в базе данных сервиса';
                                          }
                                ...
                                : () {
                                    ...
                                    if (!regExp.hasMatch(value)) {
                                      textFieldColor[0] = Colors.red;
                                      textError = 'Телефон должен содержать 10 цифр';
                                    }
                                    value = password.text;
                                    if (!(value.length > 7)) {
                                      textFieldColor[1] = Colors.red;
                                    ...
                                    value = telegram.text;
                                    regExp = RegExp(r"^@\w{1,}$");
                                    if (!regExp.hasMatch(value) && telegram.text != '') {
                                      textFieldColor[2] = Colors.red;
                                      isPressed = true;
                                    }
                                    value = email.text;
                                    ...
                                    if (!regExp.hasMatch(value) && email.text != '') {
                                      textFieldColor[2] = Colors.red;
                                      textError = 'Неправильно введена почта';
                                      isPressed = false;
                                    }
                                    if (!isPicked) {
                                      textError = 'Потдвердите условия пользования сервиса';
