  ...
  void initState() {
    ...
    update = Timer.periodic(
      ...
      (timer) {
        ...
        weeks = dateOfBorn.difference(nowDate).inSeconds ~/ 60 ~/ 60 ~/ 24 ~/ 7;

        days =
            (dateOfBorn.difference(nowDate).inSeconds - weeks * 7 * 24 * 60 * 60) ~/ 60 ~/ 60 ~/ 24;

        hours = (dateOfBorn.difference(nowDate).inSeconds -
                weeks * 7 * 24 * 60 * 60 -
                days * 60 * 60 * 24) ~/
            60 ~/
            60;

        minutes = (dateOfBorn.difference(nowDate).inSeconds -
                weeks * 7 * 24 * 60 * 60 -
                days * 60 * 60 * 24 -
                hours * 60 * 60) ~/
            60;

        seconds = (dateOfBorn.difference(nowDate).inSeconds -
            weeks * 7 * 24 * 60 * 60 -
            days * 60 * 60 * 24 -
            hours * 60 * 60 -
            minutes * 60);
                                  ...
                                  child: TextField(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      context
                                          ...
                                          .add(SetAdditionalSumEvent(additionalSum: additionalSum));
                                      setState(() {});
                                    },
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: const TextStyle(
                                        color: Color.fromRGBO(105, 114, 119, 1),
                                        fontFamily: 'Roboto',
                                        fontWeight: FontWeight.w200,
                                        fontSize: 16,
                                      ),
                      ...
                      DecoratedBox(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              CounterSegmentWidget(weeks, "недель"),
                              CounterSegmentWidget(days, "дней"),
                              CounterSegmentWidget(hours, "часов"),
                              CounterSegmentWidget(minutes, "минут"),
                              CounterSegmentWidget(seconds, "секунд"),
                            ],
                          ),
                        ),
                      ),
