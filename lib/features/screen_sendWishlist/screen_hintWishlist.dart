...
class ScreenHintWishlist extends StatefulWidget {
  const ScreenHintWishlist({
    super.key,
  });

  @override
  State<ScreenHintWishlist> createState() => _ScreenHintWishlistState();
}
